...
def enter_data():
    ...
    if accepted=="Accepted":
            ...
            if firstname and lastname:
                ...
                print("# Courses: ", numcourses, "# Semesters: ", numcourses)
...
registered_check = tkinter.Checkbutton(courses_frame, text="Currently Registered", variable=reg_status_var, onvalue="Registration", offvalue="Not registered")
...
accept_var = tkinter.StringVar(value="Not Acceptd")
